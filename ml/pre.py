...
def selected_feature(X, y):             
    ...
    plt.xticks(range(1,X.shape[1]+1,1),fontsize=15)             
...
def build_Moudle(X, y, Xtrain,Ytrain,Xtest,Ytest):                
    ...
    if best_classifier == "逻辑回归":               
        ...
        Ytrain_pred,Ytest_pred,pred_score_more,pred_score_2 = ml_svm(Xtrain,Ytrain,Xtest,Ytest)
        return Ytrain_pred,Ytest_pred,pred_score_more,pred_score_2             
        ...
        Ytrain_pred,Ytest_pred,pred_score_more,pred_score_2 = ml_xgb(Xtrain,Ytrain,Xtest,Ytest)
        return Ytrain_pred,Ytest_pred,pred_score_more,pred_score_2             
...
def evaluate_model(Ytrain,Ytest,Ytrain_pred,Ytest_pred,pred_score_more,pred_score_2,multi_class='ovo'):             
